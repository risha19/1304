...
<html lang="ru">
  ...
  <p>   
    ...
    //1
    function getInput() {
        let inputArg1 = document.querySelector(".task1-input"); 
        let resultInput = document.querySelector(".input-result");
        let arg1 = inputArg1.value;
        resultInput.textContent =arg1;
    }
    //2
    ...
    function changePicture() {
        let pictureB = document.querySelector(".left-fruit");
        let pictureA = document.querySelector(".right-fruit");
        let srcBanana = pictureB.getAttribute('src');
        pictureA.setAttribute("src", srcBanana);
    }
    //4
    function removeClass() {
        let classTask4 = document.querySelector(".task-4 div");//.task-4 .box
       
        classTask4.classList.toggle("d-none");
    }
